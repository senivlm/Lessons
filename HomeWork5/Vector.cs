...
namespace Vector
{
    ...
    {// У Вас тільки класичний застосунок алгоритму інтернетівської реалізації.
        //Надіюсь, що Ви освоїли цей код. Але я не побачила файлу з демонстрацією застосунку, 
        //а також врахування обмеження на використання ресурсу.якщо я не помітила, вкажіть мені про це.
        int[] array;
        public Vector(int n)
        {
            array = new int[n];
